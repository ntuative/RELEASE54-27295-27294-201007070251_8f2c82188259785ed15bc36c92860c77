package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_556 = new FZipFile(this,charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  var_100 = parseIdle;
                  break;
               default:
                  dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_139,"Unknown record signature."));
            }
            return true;
         }
         return false;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_139))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_139,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_99 && var_100 == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_139,"EOF"));
            }
         }
      }
      ...
      {
         if(var_556.parse(param1))
         {
            var_50.push(var_556);
            if(false)
            {
               var_144["null"] = var_556;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1414,var_556));
            var_556 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_50 != null && var_144 != null && param1 < var_50.length)
         {
