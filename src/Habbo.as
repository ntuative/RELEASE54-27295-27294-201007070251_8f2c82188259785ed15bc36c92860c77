package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_11:String = "byteBarSprite";
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc10_:Sprite = _loc9_.getChildByName(const_11) as Sprite;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
      ...
      {
         trackLoginStep(const_9);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + var_9,const_7,null);
      }
