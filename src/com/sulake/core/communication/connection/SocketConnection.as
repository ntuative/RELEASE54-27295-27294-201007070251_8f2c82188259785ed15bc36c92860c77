package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1208:int = 10000;
      ...
      private var var_870:IEncryption;
      ...
      private var var_357:IConnectionStateListener;
      
      private var var_616:IProtocol;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_307 = param2;
         var_271 = new ByteArray();
         var_869 = new MessageClassManager();
         var_74 = new Socket();
         var_358 = new Timer(const_1208,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = var_616.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_357)
         {
            var_357.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_870 != null)
         {
            _loc3_ = var_870.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_357)
         {
            var_357.connectionInit(param1,param2);
         }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_271.writeByte(var_74.readUnsignedByte());
         }
         logConnection(">>[SOCKET]: " + var_271.toString());
      }
      ...
      {
         var_307.addConnectionMessageEvent(_id,param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = var_616.getMessages(var_271,receivedMessages);
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(var_357)
               {
                  var_357.messageReceived(String(id),data.toString());
               }
               logConnection(">>[SocketConnection] timestamp:" + getTimer() + " Received message id: " + id + " data: " + data.toString());
               eventClasses = var_869.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = var_307.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  else
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = var_307.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(var_271,offset);
               var_271 = temp;
               logConnection("[SOCKET REST] offset: " + offset + " rest: " + var_271.toString());
            }
         }
         catch(e:Error)
         {
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_870 + "\n");
      }
   }
}
