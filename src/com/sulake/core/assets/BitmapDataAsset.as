package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      private var var_1288:AssetTypeDeclaration;
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is BitmapDataAsset)
         {
            _bitmap = BitmapDataAsset(param1)._bitmap;
            _offset = BitmapDataAsset(param1)._offset;
            var_1146 = BitmapDataAsset(param1).var_1146;
            var_1147 = BitmapDataAsset(param1).var_1147;
            if(_bitmap != null)
            {
               return;
            }
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_1146 = _loc4_ == "1" || _loc4_ == "ParkBusCannotEnterMessageParser";
                  break;
               case "flipV":
                  var_1147 = _loc4_ == "1" || _loc4_ == "ParkBusCannotEnterMessageParser";
                  break;
            }
            _loc2_++;
         }
