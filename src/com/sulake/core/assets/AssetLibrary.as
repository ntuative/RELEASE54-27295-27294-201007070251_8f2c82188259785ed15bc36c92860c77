package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1155:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_666:uint = 0;
      
      public static const const_578:String = "AssetLibraryReady";
      
      public static const const_1242:String = "AssetLibraryUnloaded";
      
      public static const const_454:String = "AssetLibraryLoaded";
      
      public static const const_1391:String = "AssetLibraryLoadError";
       
      
      private var var_565:XML;
      ...
      private var var_566:Boolean = true;
      
      private var var_385:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_666;
         var_460 = new Dictionary(false);
         var_459 = new Dictionary(false);
         var_800 = new Dictionary(false);
         var_146 = new Dictionary(false);
         var_1155.push(this);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_460)
         {
            _loc4_ = AssetTypeDeclaration(var_460[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = var_459[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_459[_loc1_];
         }
         for(_loc1_ in var_146)
         {
            delete var_146[_loc1_];
         }
         for(_loc1_ in var_800)
         {
            delete var_800[_loc1_];
         }
         if(var_17 != null)
         {
            var_17.dispose();
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in var_146)
         {
            _loc3_ = var_146[_loc2_];
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_565 = _loc2_.manifest.copy();
         var_385 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_566)
         {
            AssetLibrary.fetchLibraryContents(this,var_565,var_385);
         }
         var_329 = true;
         dispatchEvent(new Event(AssetLibrary.const_454));
         dispatchEvent(new Event(AssetLibrary.const_578));
         if(var_566)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_459[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_972,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1052,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_906,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_459[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_460.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_460[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1155.splice(var_1155.indexOf(this),1);
            --var_666;
            var_459 = null;
            var_800 = null;
            var_146 = null;
      ...
      {
         return param1 < var_386.length ? getAssetByName(var_386[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in var_146)
         {
            if(var_146[_loc2_] == param1)
            {
               return var_386.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_460)
         {
            _loc3_ = AssetTypeDeclaration(var_460[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_800[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_565.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_385[param1]);
      ...
      {
         var _loc2_:IAsset = var_146[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_459[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++var_216;
                     var_386.push(struct.assetName);
                  }
                  var_146[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_42,e.status);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_146)
            {
               if(var_146[_loc2_] == param1)
               {
                  var_386.splice(var_386.indexOf(_loc2_),1);
                  delete var_146[_loc2_];
                  --var_216;
                  return param1;
               }
            }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_460[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_385 != null ? false : false;
      }
   }
}
