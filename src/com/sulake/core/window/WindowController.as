package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1457:String = "_IGNORE_INHERITED_STYLE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      private static var var_1452:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      private static var var_1694:Point = new Point();
      
      protected static const const_1067:String = "_COLORIZE";
      ...
      protected var var_698:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_19)
         {
            var_19 = getGraphicContext(!testParamFlag(WindowParam.const_31));
         }
         _events = new EventDispatcher(this);
         _children = new Array();
         var_337 = new Rectangle();
         if(_loc12_ != null)
         {
         ...
         if(_loc13_)
         {
            ...
            var_585 = _loc13_.treshold;
            if(var_690 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_586 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_138,WindowParam.const_145);
         var _loc2_:* = !testParamFlag(WindowParam.const_121,WindowParam.const_142);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               {
                  if(var_12.width < _loc3_.width && getParamFlag(WindowParam.const_31))
                  {
                     _loc3_.x = 0;
                  }
                  else
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_310)
               {
                  _loc3_.y += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_171)
               {
                  if(var_12.height < _loc3_.height && getParamFlag(WindowParam.const_31))
                  {
                     _loc3_.y = 0;
                  }
                  else
      ...
      {
         var_690 = param1;
         var_586 = !!var_690 ? uint(var_586 | var_1484) : uint(var_586 & 16777215);
      ...
      {
         var_585 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2350 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1275:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1404:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_19)
         {
            var_19 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_648,var_11);
            var_19.visible = var_359;
         }
         return var_19;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1173 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return !testParamFlag(WindowParam.const_31) || var_19 != null;
      }
      
      public function validateLocalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_585);
      }
      
      public function set color(param1:uint) : void
      {
         var_1484 = param1 & 4278190080;
         var_586 = !!var_690 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_74);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_639))
         {
            ...
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_279))
                        {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_167:
                  ...
                  if(param1 == this)
                  {
                     ...
                     else if(testParamFlag(WindowParam.const_171,WindowParam.const_142))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_12 != null)
                     {
                        ...
                        _param = _loc9_;
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_260,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_422:
                  _context.invalidate(this,var_11.union(var_58),WindowRedrawFlag.const_408);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1002,this,null));
                     if(var_12 != null)
                     {
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_288,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_301:
                  if(param1 == this)
                  {
                     ...
                     if(var_12 != null)
                     {
                        var_12.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_217,var_12,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_464:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_838);
                  break;
               case WindowNotifyEvent.const_423:
                  _loc6_ = new Array();
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1457) == -1)
                     {
                        _loc8_.style = var_82;
                     }
                  }
               ...
               case WindowNotifyEvent.const_429:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_408);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_217:
                  ...
                  break;
               case WindowNotifyEvent.const_458:
                  var_12.getRegionProperties(null,var_337);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_322:
      ...
      {
         return var_698 != null ? var_698 : (var_12 != null ? var_12.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_585);
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1173 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      {
         return !testParamFlag(WindowParam.const_31) ? getGraphicContext(true).fetchDrawBuffer() : (var_12 != null ? var_12.fetchDrawBuffer() : null);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_419)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_497)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_440)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_921,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_607,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1421,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_173 && var_585 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1694,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1694,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_62,false);
         _loc1_.type = WindowNotifyEvent.const_1444;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_12 != param1)
         {
            ...
            if(var_12 != null)
            {
               var_337 = var_12.rectangle.clone();
               var_58.x = var_11.x;
               var_58.y = var_11.y;
               var_58.width = var_11.width;
               var_58.height = var_11.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_377,this,var_12));
            }
            else
            {
               var_337.x = 0;
               ...
               var_337.width = 0;
               var_337.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_893,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_82,_param,_context,var_11,null,var_698,properties,var_691.concat(),_id) as WindowController;
         _loc2_.var_585 = var_585;
         ...
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_343;
         _loc2_.background = var_690;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_730;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_494;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_37 == WindowState.const_503)
         {
            return true;
         }
