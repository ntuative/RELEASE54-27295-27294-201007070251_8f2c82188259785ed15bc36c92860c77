package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1556 = new Dictionary();
         var_1919 = new Dictionary();
         TypeCodeTable.fillTables(var_1556,var_1919);
         var_1279 = new Dictionary();
         var_1920 = new Dictionary();
         StateCodeTable.fillTables(var_1279,var_1920);
         var_525 = new Dictionary();
         var_525["skin"] = BitmapSkinRenderer;
         var_525["bitmap"] = BitmapDataRenderer;
         var_525["fill"] = FillSkinRenderer;
         var_525["text"] = TextSkinRenderer;
         var_525["shape"] = ShapeSkinRenderer;
         var_525["unknown"] = SkinRenderer;
         var_525["MarketPlaceOffersEvent"] = NullSkinRenderer;
         if(var_400 == null)
         {
            var_400 = new Array();
            var_400.push(WindowState.const_62);
            var_400.push(WindowState.const_73);
            var_400.push(WindowState.const_96);
            var_400.push(WindowState.WINDOW_STATE_SELECTED);
            var_400.push(WindowState.const_80);
            var_400.push(WindowState.const_75);
            var_400.push(WindowState.const_94);
            var_400.push(WindowState.const_85);
         }
         ...
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  _loc20_.background = !!_loc7_.@background[0] ? _loc7_.@background[0] == "ParkBusCannotEnterMessageParser" : false;
                  ...
                  addSkinRenderer(var_1556[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_740[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_740[param1] = new Array(SkinContainer.const_794);
         }
         var_740[param1][param2] = param3;
         if(true)
         {
            var_741[param1] = new Array(SkinContainer.const_794);
         }
         var_741[param1][param2] = param4;
      }
