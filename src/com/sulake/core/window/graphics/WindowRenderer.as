package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1674:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_669 = new Array();
         var_1673 = new Point();
         var_1674 = new Rectangle();
         var_331 = new Rectangle();
         var_332 = new Dictionary(true);
         var_787 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_332[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_669.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_331.x = _loc3_.dirty.x;
               var_331.y = _loc3_.dirty.y;
               var_331.width = _loc3_.dirty.width;
               var_331.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_331);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_570,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_332[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1673,var_1674))
            {
               if(param2.render(param1,var_1673,var_1674))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            var_332[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_570,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_331.x = param2.x - param1.x;
            var_331.y = param2.y - param1.y;
            var_331.width = param2.width;
            var_331.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_31))
            {
               while(param1.testParamFlag(WindowParam.const_31))
               {
                  ...
                  var_331.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_331,WindowRedrawFlag.const_264);
            if(var_669.indexOf(param1) == -1)
            {
               var_669.push(param1);
            }
         }
