package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_345:Dictionary;
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_345)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_345[_loc3_] == param1)
               {
      ...
      {
         var _loc3_:ISkinLayout = var_481[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_481[_loc1_]).dispose();
      ...
      public function method_14(param1:uint) : ISkinLayout
      {
