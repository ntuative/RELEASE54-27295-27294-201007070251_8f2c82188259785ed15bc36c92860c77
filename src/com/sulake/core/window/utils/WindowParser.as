package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1498:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1708:String = "_TEMP";
      ...
      protected var var_1021:Dictionary;
      
      protected var var_1491:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1492:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(var_1021,var_1492);
         var_1491 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1102,"");
         return param1.replace(const_1101,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1021)
            {
               delete var_1021[_loc1_];
            }
            for(_loc1_ in var_1492)
            {
               delete var_1492[_loc1_];
            }
            var_1491.dispose();
            var_1491 = null;
            _context = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "ParkBusCannotEnterMessageParser";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "ParkBusCannotEnterMessageParser";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "ParkBusCannotEnterMessageParser";
