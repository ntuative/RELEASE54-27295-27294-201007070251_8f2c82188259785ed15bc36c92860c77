package com.sulake.core.window.utils
{
   ...
   public class WindowToolTipAgent extends WindowMouseOperator implements IWindowToolTipAgentService
   {
      ...
      protected var var_1207:Point;
      
      public function WindowToolTipAgent(param1:DisplayObject)
      {
         var_1208 = new Point();
         var_1207 = new Point(20,20);
         var_1029 = 500;
         super(param1);
      }
      ...
      override public function operate(param1:int, param2:int) : void
      {
         if(_window && true)
         {
            _mouse.x = param1;
            _mouse.y = param2;
            getMousePositionRelativeTo(_window,_mouse,var_1208);
            if(var_263 != null && true)
            {
               var_263.x = param1 + var_1207.x;
               var_263.y = param2 + var_1207.y;
            }
         }
      }
      ...
      protected function showToolTip(param1:TimerEvent) : void
      {
         ...
         if(_window && true)
         {
            ...
            {
               var_263 = _window.context.create("undefined::ToolTip",var_1030,WindowType.const_357,_window.style,0 | 0,null,null,null,0,null,null) as IToolTipWindow;
            }
            _loc2_ = new Point();
            _window.getGlobalPosition(_loc2_);
            var_263.x = _loc2_.x + var_1208.x + var_1207.x;
            var_263.y = _loc2_.y + var_1208.y + var_1207.y;
         }
      }
      ...
      override public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         if(param1 && !param1.disposed)
         {
            ...
            getMousePositionRelativeTo(param1,_mouse,var_1208);
