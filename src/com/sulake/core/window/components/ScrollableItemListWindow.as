package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_924:IItemListWindow;
      
      private var var_373:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_373)
         {
            var_373 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_373)
            {
               var_373.addEventListener(WindowEvent.const_271,scrollBarEventProc);
               var_373.addEventListener(WindowEvent.const_228,scrollBarEventProc);
            }
         }
         return var_373;
      }
      ...
      override public function dispose() : void
      {
         if(var_373)
         {
            var_373.removeEventListener(WindowEvent.const_271,scrollBarEventProc);
            var_373.removeEventListener(WindowEvent.const_228,scrollBarEventProc);
            var_373 = null;
         }
         if(var_924)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_924)
         {
            var_924 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_924;
      }
