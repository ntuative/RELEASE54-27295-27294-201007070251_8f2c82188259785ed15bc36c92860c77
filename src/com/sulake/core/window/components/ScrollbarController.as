package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1174:String = "increment";
      
      private static const const_526:String = "slider_bar";
      
      private static const const_1173:String = "decrement";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_526:
      ...
      {
         return track.findChildByName(const_526) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_983 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_983 != null)
         {
            _loc1_ = findParentByName(var_983) as IScrollableWindow;
            if(_loc1_ == null && var_12 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_12).findChildByName(var_983) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_47)
         {
            ...
            else if(param2.name == const_1173)
            {
               if(var_23)
               {
                  var_674 = true;
            ...
            else if(param2.name == const_829)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_526).rectangle;
               if(_horizontal)
               {
