package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_484[1] = MouseCursorType.const_37;
         var_484[2] = MouseCursorType.ARROW_LINK;
         var_484[3] = MouseCursorType.ARROW_LINK;
         var_484[4] = MouseCursorType.const_37;
         var_484[5] = MouseCursorType.const_37;
         var_484[6] = MouseCursorType.ARROW_LINK;
         if(var_348 == null)
         {
            var_348 = new Array();
            var_348[0] = WindowState.const_94;
            var_348[1] = WindowState.const_75;
            var_348[2] = WindowState.const_80;
            var_348[3] = WindowState.const_62;
            var_348[4] = WindowState.WINDOW_STATE_SELECTED;
            var_348[5] = WindowState.const_96;
            var_348[6] = WindowState.const_73;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1066,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_770));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_1057,param1.toolTipDelay != const_1456));
         return param2;
      }
