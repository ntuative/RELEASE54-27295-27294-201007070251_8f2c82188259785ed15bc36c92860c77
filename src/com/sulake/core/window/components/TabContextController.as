package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1153:String = "_CONTENT";
      
      private static const const_1152:String = "_SELECTOR";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1725 == null)
         {
            var_1725 = findChildByTag(const_1153) as IWindowContainer;
         }
         return var_1725;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_1027 == null)
         {
            var_1027 = findChildByTag(const_1152) as ITabSelectorWindow;
            if(var_1027 != null)
            {
      ...
      {
         return !!var_939 ? selector.iterator : null;
      }
