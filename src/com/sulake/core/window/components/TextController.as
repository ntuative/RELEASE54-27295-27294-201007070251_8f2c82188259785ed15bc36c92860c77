package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_593:String = "none";
      
      protected var var_697:Number;
      
      protected var var_399:Number;
      ...
      {
         return new Rectangle(var_697 * maxScrollH,var_399 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_838)
         {
            context.removeLocalizationListener(var_343,this);
         }
         if(var_72 != null)
         {
            var_72.dispose();
      ...
      {
         var_697 = param1;
         _field.scrollH = var_697 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_343 = param1;
         if(var_343.charAt(0) == "$" && var_343.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_343.slice(2,var_343.indexOf("}")),this);
            var_838 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1057,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_432,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_432,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_749,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_749,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("margin_left",var_72.left,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_top",var_72.top,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_right",var_72.right,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_72.bottom,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("auto_size",var_593,PropertyStruct.STRING,var_593 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_749,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_593 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_593 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_593 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_593 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
