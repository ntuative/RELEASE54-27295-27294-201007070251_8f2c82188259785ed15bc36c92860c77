package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1065:String = "spacing";
      
      protected static const const_1455:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1063:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1454:Boolean = true;
      
      protected static const const_1064:String = "auto_arrange_items";
      ...
      protected var var_1206:Boolean = false;
      ...
      protected var var_1497:Boolean = false;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_837:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_95 = 0;
         var_71 = 0;
         _horizontal = param2 == WindowType.const_308;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_173 = var_690 || !testParamFlag(WindowParam.const_31);
         _container = _context.create("_CONTAINER","",WindowType.const_320,WindowStyle.const_329,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.TAG_INTERNAL,WindowController.TAG_EXCLUDE]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_43,containerEventHandler);
         _container.addEventListener(WindowEvent.const_484,containerEventHandler);
         _container.addEventListener(WindowEvent.const_292,containerEventHandler);
         _container.addEventListener(WindowEvent.const_469,containerEventHandler);
         resizeOnItemUpdate = var_1206;
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_484,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_292,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1065,_spacing,PropertyStruct.const_61,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1064,var_837,PropertyStruct.const_56,var_837 != const_1454));
         _loc1_.push(new PropertyStruct(const_1063,var_592,PropertyStruct.const_56,var_592 != const_1455));
         _loc1_.push(new PropertyStruct(const_1062,var_1206,PropertyStruct.const_56,var_1206 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1062:
                  ...
                  break;
               case const_1064:
                  var_837 = _loc2_.value as Boolean;
                  break;
            }
         }
