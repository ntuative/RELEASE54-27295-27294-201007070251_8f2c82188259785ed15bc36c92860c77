package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      {
         var _loc2_:Object = var_150[param1];
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function unshift(param1:*, param2:*) : Boolean
      {
         ...
         var_150[param1] = param2;
         var_34.unshift(param2);
         var_257.unshift(param1);
         ++_length;
         return true;
      }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_150)
         {
            delete var_150[_loc1_];
         }
         _length = 0;
         var_34 = [];
         var_257 = [];
