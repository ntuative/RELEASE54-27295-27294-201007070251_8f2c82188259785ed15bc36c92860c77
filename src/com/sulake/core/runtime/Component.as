package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_954:uint = 4;
      
      public static const COMPONENT_EVENT_ERROR:String = "COMPONENT_EVENT_ERROR";
      
      public static const const_1674:uint = 1;
      ...
      protected var var_1904:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_1025 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_1025);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1205 & const_954)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_469 + "]";
      }
