package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_791:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1100:String = "tile_cursor";
      ...
      private var var_621:NumberBank;
      ...
      private var var_737:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_312 = new Map();
         var_621 = new NumberBank(1000);
         var_1069 = new Map();
         var_313 = new Map();
         var_70 = new RoomObjectEventHandler(this);
         var_737 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_70 != null)
         {
            ...
            {
               return var_70.deleteWallItem(var_119,var_118,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_647) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_601) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_558) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_564) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return var_70.modifyWallItemData(var_119,var_118,param1,param3);
            }
         }
         return false;
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_947;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_670);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_762);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_534);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1026);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_862) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_943);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_740,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_741,var_119,var_118,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            return var_70.modifyRoomObject(var_119,var_118,param1,param2,param3);
         }
         return false;
      }
      ...
      public function method_10(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_636,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_613,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_44 != null)
         {
            ...
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_34);
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_259);
            var_44.addObjectUpdateCategory(RoomObjectCategoryEnum.const_64);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_70 != null)
         {
            var_70.handleRoomObjectEvent(param1,var_119,var_118);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_15.sessionDataManager = var_372;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_209,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_315,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_306,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1027,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_992,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_953,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_273,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_644,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_29 == null || var_409 == null || var_44 == null || var_738 == null || _communication == null || _habboConfiguration == null || !var_1882)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_298,RoomObjectCategoryEnum.const_64);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1329,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_44.getRoom(getRoomIdentifier(var_119,var_118));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_792,RoomObjectCategoryEnum.const_259);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_118,var_1271);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_118,var_1271);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_15 != null)
         {
            var_15.visualizationFactory = var_409;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_29 != null)
         {
            if(false)
            {
               var_29.events.addEventListener(RoomObjectMouseEvent.const_236,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.const_441,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.const_399,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_166,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_631,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_120,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_90,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_137,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_388,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_378,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_501,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_498,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_461,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_483,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_448,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_477,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_58,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_499,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_459,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_280,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_384,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_330,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_356,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_379,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_1058,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_398,roomObjectEventHandler);
               var_29.events.addEventListener(AvatarWalkWarpingWarningEvent.const_452,warningEventHandler);
            }
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_218;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_559) != 0)
         {
            return false;
         }
         if(var_70 != null)
         {
            return var_70.initializeRoomObjectInsert(var_119,var_118,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_524 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_645,0,0));
            _loc2_ = 0;
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_273,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_907,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1055,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_209));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_504);
                     break;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_581)
         {
            var_1882 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_209,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_315,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_306,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_947,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_273,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_286.events.addEventListener(AdEvent.const_393,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_791) as Sprite;
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc11_:int = var_621.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_28:
            case RoomObjectCategoryEnum.const_26:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_209,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_504,param8);
               break;
            case RoomObjectCategoryEnum.const_34:
            ...
            case RoomObjectCategoryEnum.const_64:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_283,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_754,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_543,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_671,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_453,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1069.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_960,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_621.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_793,RoomObjectCategoryEnum.const_259);
      }
         ...
         if(_loc9_ != null)
         {
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_465,var_119,var_118,-1,RoomObjectCategoryEnum.const_218));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_70 != null)
               {
                  ...
                  var_70.handleRoomObjectEvent(_loc14_,var_119,var_118);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_118,var_1271);
         if(_loc7_ != null)
         {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_15 != null)
         {
            ...
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_338,param1.image,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_951,param1.adWarningL,true);
            var_15.addGraphicAsset(var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_874,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_884,RoomObjectVariableEnum.const_338,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_15 != null)
         {
            _events.addEventListener(RoomContentLoader.const_581,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_70 != null)
         {
            var_70.cancelRoomObjectInsert(var_119,var_118);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_960);
               ...
               var_621.freeNumber(_loc10_ - 1);
               _loc13_ = var_1069.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_119,var_118,const_298,RoomObjectCategoryEnum.const_64,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_892,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_559,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_835,_loc13_,true);
            if(var_15 != null)
            {
         ...
         else
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_559,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_670,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_601,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_564,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1005,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_636,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_613,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_453,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_244);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_762,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_534,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_762,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_534,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1026,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_793,const_1100,RoomObjectCategoryEnum.const_259);
         _loc7_.createRoomObject(const_792,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_259);
         return _loc7_;
      }
