package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_774:String = "selection_arrow";
      
      private static const const_772:String = "tile_cursor";
      
      private static const const_297:String = "RCL_PUBLICROOM_";
      
      private static const const_513:String = "wall_place_holder";
      
      private static const name_2:int = 2;
      
      private static const const_362:String = "place_holder";
      
      private static const const_1070:String = const_362;
      ...
      public static const const_581:String = "RCL_LOADER_READY";
      ...
      private var var_1034:IEventDispatcher = null;
      
      private var var_1219:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_487 = [];
         _wallItems = [];
         var_1737 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1736 = ["room_public","room_public_park","room_public_pool"];
         super();
         _libraries = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_337,_loc4_);
      ...
      {
         var _loc2_:String = var_486.getValue(param1) as String;
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = var_372.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(var_174 != null && var_174.hasWorldType(const_297 + param1))
         {
            return var_174.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_350 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_350.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_594.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_362,const_513,ROOM_CONTENT,const_772,const_774];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_28 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(var_488.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1737.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_162 && _loc5_ != RoomObjectLogicEnum.const_153)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_489.getValue(param1) as String;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_595.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1435);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_486.getValue(param1) as String;
      ...
      private function continueInitilization() : void
      {
         if(var_1732)
         {
            ...
            if(var_1034 != null)
            {
               var_1034.dispatchEvent(new Event(const_581));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_174 != null)
         {
            return var_174.getWorldHeightScale(const_297 + param1);
         }
         return 1;
      }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               var_595.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               var_489.add(_loc3_,_loc4_);
               if(var_487.indexOf(_loc7_) < 0)
               {
                  var_487.push(_loc7_);
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               var_486.add(_loc3_,_loc4_);
               if(_wallItems.indexOf(_loc7_) < 0)
               {
                  _wallItems.push(_loc7_);
               }
            }
            _loc8_ = var_488.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               var_488.remove(_loc7_);
               var_488.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_1738 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_1735 = param2.getKey("public.room.dynamic.download.url","");
         var_1734 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         var_37 = const_773;
         initFurniData();
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_350.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_162 && _loc5_ != RoomObjectVisualizationEnum.const_153)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_297 + param1) == RoomObjectCategoryEnum.const_64)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1219.getValue(param1) != null)
         {
            var_174 = var_1219.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_454,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_174 != null)
         {
            return var_174.getWorldScale(const_297 + param1);
         }
         return 32;
      }
   }
