package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_318:int = 1000;
      ...
      private var var_577:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_577 = var_297.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_577 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_297 != null)
         {
            ...
            {
               _loc1_ = var_297.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_297.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_297.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
