package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_832:int = 1;
      
      private static const const_1180:int = 0;
      ...
      {
         super();
         moveUpdateInterval = const_928;
         var_1707 = new Vector3d();
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_928 / _loc3_.state;
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            var_1707.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),var_1707).length > 0)
            {
               if(object.getState(0) != const_832)
               {
                  object.setState(const_832,0);
               }
            }
            else
            {
               object.setState(const_1180,0);
            }
         }
      }
   }
