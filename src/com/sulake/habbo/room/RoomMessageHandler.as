package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1150:int = -1.0E9;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_967,_loc3_.status);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_670);
         var _loc8_:int = 0;
      ...
      private function onRoomProperty(param1:IMessageEvent) : void
      {
         ...
         if(var_13 != null)
         {
            var_13.method_10(_loc4_,_loc5_,_loc6_,_loc7_,_loc8_);
         }
      }
