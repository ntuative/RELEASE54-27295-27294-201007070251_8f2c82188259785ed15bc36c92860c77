package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_417:PartSetsData;
      
      private var var_1561:PartOffsetData;
      
      private var var_899:AvatarActionManager;
      
      private var var_183:IAssetLibrary;
      
      private var var_898:IAssetLibrary;
      
      private var var_428:AvatarRenderManager;
      
      private var var_315:FigureData;
      
      private var var_640:AnimationData;
      ...
      private var var_746:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_417 = new PartSetsData();
         var_640 = new AnimationData();
         var_1560 = new AvatarStructureDownloadSet();
         var_746 = new AnimationManager();
         var_624 = param4;
         var_1561 = PartOffsetData.getInstance(param3);
      ...
      {
         return var_899.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_899.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_315.method_11(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_899.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_746.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_417.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_417.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1188[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_899.getDefaultAction();
         var _loc9_:Array = var_417.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_746.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
               ...
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_640.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_417.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_417.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_624 + " ready to go!");
         if(var_624 == AvatarType.const_67)
         {
            var_417.getPartDefinition("ri").appendToFigure = true;
            var_417.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_624)
         {
            case AvatarType.const_67:
               ...
               var_1560.add(new AvatarStructureDownload(var_183,_loc5_,var_315));
               break;
            case AvatarType.PET:
         }
      ...
      {
         return var_746.getAnimation(param1);
      }
      ...
      {
         var_899 = new AvatarActionManager(var_183,var_624);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(true)
         {
            var_747[param1] = new Dictionary();
         }
         if(var_747[param1][param2])
         {
            return var_747[param1][param2];
         }
         var_747[param1][param2] = var_315.getMandatorySetTypeIds(param1,param2);
         return var_747[param1][param2];
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_898.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_898.getAssetByName("dance" + _loc1_).content as XML;
            var_746.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_898.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_898.getAssetByName("fx" + _loc1_).content as XML;
            var_746.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         var_1561.loadOffsets(var_898);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_899.sortActions(param1);
      }
   }
}
