package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2410:int = 6710886;
      ...
      private var var_558:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_557:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         var_1145 = [];
         var_1162 = [AvatarEditorFigureCategory.const_612,AvatarEditorFigureCategory.const_41,AvatarEditorFigureCategory.const_215,AvatarEditorFigureCategory.const_701,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_91];
         super();
         _controller = param1;
         ...
         var_383 = new Timer(1000);
         var_383.addEventListener(TimerEvent.TIMER,onUpdate);
         if(param4 == null)
         {
            param4 = var_1162;
         }
      ...
      public function update() : void
      {
         ...
         if(_controller.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1653 == AvatarEditorSideCategory.const_91 || var_2228))
         {
      ...
      public function dispose() : void
      {
         ...
         {
            var_383.stop();
            var_383.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_383 = null;
         }
         if(_window != null)
         {
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_557)
         {
            ...
            var_557 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_557.procedure = stripClubDialogEventProc;
            var_557.center();
         }
         else
         {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         var_558 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = -1;
         while(_loc2_ >= 0)
         {
            _loc4_ = var_558.getSelectableAt(_loc2_);
            if(_loc4_ != null && var_1145.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = var_558.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < var_558.numSelectables)
               {
                  var_558.getSelectableAt(_loc6_).x = var_558.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1162);
         }
         if(param1.length != var_1145.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(var_1145.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      {
         if(var_1653 == AvatarEditorSideCategory.const_91)
         {
            var_2228 = false;
            setSideContent(AvatarEditorSideCategory.const_554);
         }
         else
         {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_270 = param1;
         var_558.setSelected(var_558.getSelectableByName(param1));
         _window.invalidate();
      }
