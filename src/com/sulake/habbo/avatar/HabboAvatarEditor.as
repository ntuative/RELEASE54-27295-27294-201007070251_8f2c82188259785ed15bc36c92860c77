package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1084:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1085:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
       
      
      private var _view:AvatarEditorView;
      
      private var var_857:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_717.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_172)
         {
            ...
            var_498["null"] = new FigureData(this);
            var_498["null"] = new FigureData(this);
            _loc1_ = var_498["null"];
            _loc2_ = var_498["null"];
            _loc1_.loadAvatarData(const_1084,FigureData.const_72);
            _loc2_.loadAvatarData(const_1085,FigureData.FEMALE);
            var_96 = new Map();
            var_408 = new Map();
            var_96.add(AvatarEditorFigureCategory.const_612,new BodyModel(this));
            var_96.add(AvatarEditorFigureCategory.const_41,new HeadModel(this));
            var_96.add(AvatarEditorFigureCategory.const_215,new TorsoModel(this));
            var_96.add(AvatarEditorFigureCategory.const_701,new LegsModel(this));
            var_96.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            var_408.add(AvatarEditorSideCategory.const_91,new WardrobeModel(this));
            var_408.add(AvatarEditorSideCategory.const_394,new ClubPromoModel(this));
            var_172 = true;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = isClubTryoutAllowed() && var_1524;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || var_1055 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_1086)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = var_407.getMandatoryAvatarPartSetIds(gender,_loc20_);
            }
            else
            {
               _loc14_ = var_407.getMandatoryAvatarPartSetIds(gender,clubMemberLevel);
            }
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1411)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || var_1055 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_408.getValue(AvatarEditorSideCategory.const_91);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_857 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_717.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_408.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false) : Boolean
      {
         ...
         else
         {
            if(var_233 == null)
            {
               var_233 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_51,HabboWindowStyle.const_37,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            toggleAvatarEditorPage(AvatarEditorFigureCategory.const_612);
         }
         var_1054 = param2;
         return true;
      }
      ...
      {
         var_717 = var_407.getFigureData(AvatarType.const_67);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_407 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1055 = param3;
         var _loc4_:FigureData = var_498[param2];
         if(_loc4_ == null)
         {
            return;
         }
