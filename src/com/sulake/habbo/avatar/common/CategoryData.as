package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_815 >= 0 && var_192.length > var_815)
         {
            _loc2_ = var_192[var_815];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_192.length > param1)
         {
            _loc3_ = var_192[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_221.length)
         {
            ...
            {
               if(_loc7_.length > var_221[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_221[param2],param2);
         var_221[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_221[param1])
         {
            return null;
         }
      ...
      {
         return var_192[var_815] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_221 = new Array(param1.length);
         var _loc3_:int = 0;
