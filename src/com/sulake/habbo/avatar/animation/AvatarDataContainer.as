package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1661:Number = 1.0;
      ...
      private var var_1660:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1660,var_1661,var_1662,_alphaMultiplier);
         var_1086 = generatePaletteMapForGrayscale(var_1976,var_1974);
      }
