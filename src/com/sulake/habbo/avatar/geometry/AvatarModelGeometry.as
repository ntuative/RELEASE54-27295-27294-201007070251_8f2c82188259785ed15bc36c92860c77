package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1547:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         super();
         var_518 = new Matrix4x4();
         var_732 = new Dictionary();
         var_1547 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            var_732[String(_loc6_.@id)] = _loc7_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_518 = var_518.identity().rotateY(param3);
            return _loc5_.getParts(var_518,var_875,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1547.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_732[param1] as Dictionary;
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_518 = var_518.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_518);
            _loc10_ = _loc8_.getDistance(var_875);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_732[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1547.findAvatarSet(param1);
         if(_loc3_ != null)
         {
