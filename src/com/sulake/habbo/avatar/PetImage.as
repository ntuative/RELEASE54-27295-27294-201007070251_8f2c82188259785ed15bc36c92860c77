package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         var_420 = new AvatarFigureContainer(param3);
         var _loc5_:int = var_420.getPartSetId("pbd");
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_41)
         {
            ...
            _loc3_ = var_83.renderManager.petDataManager.getPetData(var_1231);
            if(_loc3_ != null)
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = var_83.getParts(_loc9_,var_420,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               ...
               if(_loc16_.length > 0)
               {
                  ...
                  _loc23_ = var_83.getPartActionOffset(getSubType(),var_154,_loc9_,_loc15_,_loc20_,_loc21_);
                  if(_loc23_ != null)
                  {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = var_83.getCanvas(var_154,var_261.definition.geometryType);
         if(_image == null || _loc4_ != null && (_image.width != _loc4_.width || _image.height != _loc4_.height))
         {
            _loc4_ = var_83.getCanvas(var_154,var_261.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = var_83.getParts(_loc8_,var_420,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = var_1231 < 3;
               ...
               if(_loc15_.length > 0)
               {
                  ...
                  _loc22_ = var_83.getPartActionOffset(getSubType(),var_154,_loc8_,_loc14_,_loc19_,_loc20_);
                  if(_loc22_ != null)
                  {
         ...
         switch(param1)
         {
            case AvatarAction.const_468:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1443:
                  case AvatarAction.const_1033:
                  case AvatarAction.const_919:
                  case AvatarAction.const_1433:
