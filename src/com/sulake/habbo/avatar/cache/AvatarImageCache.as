package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1462:int = 60000;
      ...
      {
         if(var_601 == param1 || var_601 == GeometryType.const_905 && param1 == GeometryType.const_894 || param1 == GeometryType.const_905 && var_601 == GeometryType.const_894)
         {
            var_601 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_589)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_376)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_83.getParts(param1,var_960.getFigure(),_loc6_,var_601,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_83.getCanvas(var_154,var_601);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1232[param1])
            {
            ...
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               if((_loc30_ == AvatarAction.const_859 || _loc30_ == AvatarAction.const_416) && (_loc6_ == AvatarBodyPartType.const_215 || _loc6_ == AvatarBodyPartType.const_1207 || _loc6_ == AvatarBodyPartType.const_1361) && _loc7_.color != null)
               {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_129 != null)
         {
            ...
            {
               _loc5_ = var_129.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
