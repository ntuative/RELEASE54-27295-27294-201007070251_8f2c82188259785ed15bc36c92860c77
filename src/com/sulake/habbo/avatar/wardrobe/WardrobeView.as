package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_716 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1053 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_716)
         {
            var_716.removeListItems();
         }
         if(var_1053)
         {
            var_1053.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_716)
               {
                  var_716.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1053)
            {
               var_1053.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
