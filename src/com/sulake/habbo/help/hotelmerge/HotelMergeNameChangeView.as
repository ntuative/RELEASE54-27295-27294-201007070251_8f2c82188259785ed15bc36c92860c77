package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!var_656)
         {
            var_656 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_656)
            {
               return;
            }
            _window.content.addChild(var_656);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!var_266)
         {
            var_266 = createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!var_266)
            {
               return;
            }
            _window.content.addChild(var_266);
         }
         _window.caption = _controller.localization.getKey("hotel_merge.name_change.title.confirm");
         var _loc1_:ITextWindow = var_266.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = var_377;
         }
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1371 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_844 = new NameSuggestionListRenderer(_controller);
