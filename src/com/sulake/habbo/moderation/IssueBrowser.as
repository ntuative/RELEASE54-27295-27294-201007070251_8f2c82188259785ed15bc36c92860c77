package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1621:IIssueBrowserView;
      
      private const const_1752:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1751:String = "picked_issues";
      ...
      private const const_1753:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_245:ITabContextWindow;
      
      private var var_1620:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_245 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_245.numTabItems)
            {
               _loc5_ = var_245.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_245.selector.getSelectableByName("open_issues");
         var_245.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_380.view.width = var_245.container.width;
         var_380.view.height = var_245.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1753:
               if(var_1622 == null)
               {
                  var_1622 = new MyIssuesView(issueManager,this,var_245.container);
               }
               return var_1622;
            case const_1752:
               if(var_1621 == null)
               {
                  var_1621 = new OpenIssuesView(issueManager,this,var_245.container);
               }
               return var_1621;
            case const_1751:
               if(var_1620 == null)
               {
                  var_1620 = new PickedIssuesView(issueManager,this,var_245.container);
               }
               return var_1620;
            default:
               return null;
