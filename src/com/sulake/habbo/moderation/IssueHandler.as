package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1094:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.releaseBundle(var_120.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_423 = new UserInfoCtrl(_window,var_60,_loc3_.message);
         var_1094 = new UserInfoCtrl(_window,var_60,_loc3_.message);
         var_423.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_120.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1094.load(_loc4_,var_120.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.closeBundle(var_120.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_60.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_60,WindowTracker.const_956,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_60 != null && false && var_120 != null)
         {
            var_60.issueManager.removeHandler(var_120.id);
         }
         this.dispose();
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.closeBundle(var_120.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.closeBundle(var_120.id,3);
         checkAutoHandling();
         dispose();
      }
