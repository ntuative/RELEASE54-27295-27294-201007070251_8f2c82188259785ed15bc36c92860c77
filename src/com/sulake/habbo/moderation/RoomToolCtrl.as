package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_711:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_750,_data.flatId),var_53,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_711.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1312,_loc2_,var_462.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1041.isSelected,var_1040.isSelected,var_711.isSelected));
         }
         this.dispose();
      }
      ...
      public function populate() : void
      {
         ...
         var_711 = ICheckBoxWindow(var_53.findChildByName("kick_check"));
         var_1041 = ICheckBoxWindow(var_53.findChildByName("lock_check"));
         var_1040 = ICheckBoxWindow(var_53.findChildByName("changename_check"));
