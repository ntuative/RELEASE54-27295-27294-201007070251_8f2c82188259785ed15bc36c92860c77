package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2523:BitmapData;
      
      private var var_2524:BitmapData;
      
      private var var_623:IssueBrowser;
      
      private var var_1590:IWindowContainer;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_51 = param3;
         var_1256 = param4;
         var_1590 = var_623.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1590 == null)
            {
               return;
            }
            _loc2_ = var_1590.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_623.assets.getAssetByName(_loc8_) as BitmapDataAsset;
