package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_750:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1304:int = 7;
      
      public static const const_956:int = 3;
      
      public static const const_1193:int = 8;
      ...
      {
         var_1659 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1659[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1659[param1] = _loc2_;
         }
         return _loc2_;
      }
