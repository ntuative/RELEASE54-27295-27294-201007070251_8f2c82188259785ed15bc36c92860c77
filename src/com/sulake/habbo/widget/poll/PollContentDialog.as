package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_813[var_1165] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_336)
         {
            ...
            var_336 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_336.center();
            var_336.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1165;
         if(var_1165 < var_813.length)
         {
            _loc1_ = var_813[var_1165] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_813.length);
                  _loc2_.text = _loc6_;
               }
