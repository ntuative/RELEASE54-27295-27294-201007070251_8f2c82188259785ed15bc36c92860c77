package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_987:IWindow;
      
      private var var_986:IWindow;
      ...
      {
         super();
         var_190 = new Timer(1000);
         var_190.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_986 = _window.findChildByName("effect_hilite");
            var_986.visible = false;
         }
         var_985 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_987 = _window.findChildByName("loader_bar");
         if(var_987 != null)
         {
            var_450 = var_987.width;
            var_190.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_190.stop();
            var_190.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_190 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_985 != null)
         {
            var_985.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_985.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
