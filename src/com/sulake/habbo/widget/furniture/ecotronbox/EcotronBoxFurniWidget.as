package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      {
         var _loc1_:* = null;
         if(var_258 || var_168 == -1 || !_controller)
         {
            return;
         }
         var_258 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_714,var_168);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_51,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1071,const_1073,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_223 != null)
         {
            _loc6_.caption = var_223;
         }
