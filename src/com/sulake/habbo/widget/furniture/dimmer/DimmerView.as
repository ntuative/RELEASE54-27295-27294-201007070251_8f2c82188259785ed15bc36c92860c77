package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_567:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_2282:int;
      
      private var var_387:DimmerViewAlphaSlider;
      ...
      private function method_3(param1:int) : void
      {
         if(var_245 == null)
         {
            return;
         }
         var _loc2_:IWindow = var_245.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_245.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_51,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1071,const_1073,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_567 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_387 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_245 = ITabContextWindow(_window.findChildByName("tab_context"));
         method_3(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_245.numTabItems)
         {
            _loc6_ = var_245.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_567 != null)
         {
            var_567.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_245.selector.getSelected();
         return var_245.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_387 != null)
         {
            var_387.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         method_3(param1);
         var_1156 = _loc2_.light;
         if(var_387 != null)
         {
            var_387.setValue(var_1156);
         }
         var_463 = colors.indexOf(_loc2_.color);
         if(var_567 != null)
         {
            var_567.setSelectedColorIndex(var_463);
         }
