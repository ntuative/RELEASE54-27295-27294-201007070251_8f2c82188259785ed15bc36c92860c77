package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_787:String = "Boy";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_319,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_856,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_305,onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_319:
               ...
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_305:
               hideEditorInterface();
         }
      }
      ...
      {
         hideGenderSelectionInterface();
         var_168 = param1.objectId;
         var_1750 = param1.objectCategory;
         ...
         _window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_51,HabboWindowStyle.const_35,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
         ...
         _loc4_ = _window.findChildByName(const_787);
         if(_loc4_ != null)
         {
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_319,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_856,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_305,onUpdate);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_93,true);
         var_617 = _loc4_;
         var_617.offset(100,100);
         var _loc6_:IWindow = var_617.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_341,param1,var_168,var_1750,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_617 != null)
         {
            _loc1_ = var_617 as IFrameWindow;
            if(_loc1_ != null)
            {
