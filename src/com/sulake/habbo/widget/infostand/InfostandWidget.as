package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1232:InfoStandPetData;
      
      private var var_138:Timer;
      
      private var var_910:InfoStandFurniView;
      
      private var var_440:InfostandFurniData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_910 = new InfoStandFurniView(this,const_1475);
         var_209 = new InfoStandUserView(this,const_1476);
         var_319 = new InfoStandPetView(this,const_1477);
         var_370 = new InfoStandBotView(this,const_1474);
         var_410 = new InfostandUserData();
         var_440 = new InfostandFurniData();
         var_1232 = new InfoStandPetData();
         var_138 = new Timer(const_1741);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_209.setTags(param1.tags,var_1991);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_251,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_735,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_718,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_482,var_319.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_251,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_735,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_718,onBadgeImage);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_51,HabboWindowStyle.const_35,HabboWindowParam.const_35,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_114:
               _loc2_ = param1.id == var_440.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_251:
               ...
               {
                  _loc2_ = param1.id == var_1232.roomIndex;
                  break;
               }
