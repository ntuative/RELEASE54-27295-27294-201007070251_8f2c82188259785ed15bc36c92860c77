package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1747:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1352 != null && var_1352.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_938 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_938 += param1.height + const_1748;
            return fit(param1);
         }
         param1.offset(_offsetX,var_938);
         _offsetX += param1.width + const_1747;
         return true;
      }
