package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_527:int = 6;
      
      private static const const_373:int = 10;
      
      private static const const_1175:Number = 18;
      
      private static const const_1495:Number = 10;
      
      private static const const_1494:Number = 8;
      ...
      private var var_222:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_1170,var_1168,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1170,var_816,var_1168,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1451 = param1.chatType;
         var_1170 = param1.userId;
         var_816 = param1.userName;
         var_1168 = param1.userCategory;
         _message = param1.text;
         var_1450 = param1.userX;
         var_222 = param1.userImage;
      ...
      public function renderView() : void
      {
         ...
         if(var_222 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_222.height);
         }
         ...
         if(var_222 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_222.width;
               _loc28_.height = var_222.height;
               _loc28_.bitmap = new BitmapData(var_222.width,var_222.height,true,0);
               _loc28_.bitmap.copyPixels(var_222,var_222.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_467 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_222.width;
            }
         }
         if(_loc18_ != null)
         {
         ...
         if(_loc20_ != null)
         {
            if(var_1451 == RoomWidgetChatUpdateEvent.const_263)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_816);
            }
            else if(var_1451 == RoomWidgetChatUpdateEvent.const_254)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_816);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_467;
            _loc20_.width = _loc20_.textWidth + const_527;
            _width += _loc20_.textWidth + const_527;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_373 + _loc20_.textWidth + const_527;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1170,var_1168,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1170,var_1168,_roomId,_roomCategory,param1);
      }
