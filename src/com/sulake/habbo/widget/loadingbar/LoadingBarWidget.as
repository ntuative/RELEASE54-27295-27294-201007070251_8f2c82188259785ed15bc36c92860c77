package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_441:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_441 = new Sprite();
            var_441.addChild(new Bitmap(_image));
            var_441.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_441.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_441);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1614 != "")
         {
            HabboWebTools.openWebPage(var_1614);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_441 != null)
         {
            var_441.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_441 = null;
         }
         if(_image != null)
         {
