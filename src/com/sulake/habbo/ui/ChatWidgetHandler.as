package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_895:Number = 0.0;
      ...
      public function dispose() : void
      {
         ...
         if(var_361 != null)
         {
            ...
            {
               _loc2_ = var_361.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = var_361.getValue(_loc15_) as BitmapData;
                           }
                           else
                           {
      ...
      {
         return [RoomWidgetChatMessage.const_622,RoomWidgetChatSelectAvatarMessage.const_684];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_622:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_148,_container.roomSession,0,"Version 27295-27294-201007070241");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_684:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_895 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_895);
            }
            if(var_526 == null)
            {
               var_527.x = 0;
