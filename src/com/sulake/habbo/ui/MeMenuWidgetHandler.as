package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_733:
               ...
               break;
            case RoomWidgetWaveMessage.const_619:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_673:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_716:
               if(var_14 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_585:
               if(var_14 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_634:
               if(var_14 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_698:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1024)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_234,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_745:
               ...
               if(var_14 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_902:
                        _catalog.openCatalogPage(CatalogPageName.const_1246,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_966:
                        var_14.toggleInventoryPage(InventoryCategory.const_272);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1256:
                        var_14.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1199:
                        break;
                     default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_952:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_723:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_615:
            ...
            case RoomWidgetToolbarMessage.const_707:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_389,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_353:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_588:
            ...
            case RoomWidgetStoreSettingsMessage.const_640:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_313,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_711:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_449));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_341:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_667));
               break;
            default:
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_545,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_445,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_545,onFigureUpdate);
         ...
         if(var_14 != null)
         {
            (var_14 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_836,onAvatarEffectsChanged);
            (var_14 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_882,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_445,onHelpTutorialEvent);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_619);
         _loc1_.push(RoomWidgetDanceMessage.const_673);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_716);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_585);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_634);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_539);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_745);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_698);
         _loc1_.push(RoomWidgetStopEffectMessage.const_761);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1241);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_952);
         _loc1_.push(RoomWidgetToolbarMessage.const_615);
         _loc1_.push(RoomWidgetToolbarMessage.const_707);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_353);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1379);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_896);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_723);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_733);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_588);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1315);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_709);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_640);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_711);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_624));
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_842,HabboToolbarIconEnum.MEMENU);
