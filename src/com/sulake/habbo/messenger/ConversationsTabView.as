package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_144 ? var_139.conversations.findConversation(param2.id) : var_139.conversations.openConversations[_loc3_ + var_139.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
