package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1335:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_914:String = "group_badge";
       
      
      private const const_1473:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1473,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1473 + param1;
         ...
         switch(param2)
         {
            case const_1335:
               if(var_136 != null)
               {
                  _loc5_ = var_136.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_914:
               if(var_136 != null)
               {
                  if(var_136 != null)
                  {
                     _loc5_ = var_136.getKey("group.badge.url");
