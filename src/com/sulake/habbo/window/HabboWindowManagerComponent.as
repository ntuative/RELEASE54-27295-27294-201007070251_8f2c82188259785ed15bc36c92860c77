package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1415:IEventDispatcher;
      
      private var var_2537:uint = 0;
      
      private var var_1414:ProfilerAgentTask;
      
      private var var_1416:ProfilerOutput;
      
      private var var_797:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1415 = Component(param1).events;
         var_458 = new Array();
      ...
      {
         return var_252[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_252[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_797 = new WindowRenderer(var_787);
         var_252 = new Array(const_370);
         var _loc5_:int = 0;
         while(_loc5_ < const_370)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_797,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_252[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_233 = var_252[const_1164];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_233.getMouseCursor().defineCustomCursorType(MouseCursorType.ARROW_LINK,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_233.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1438,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_252[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_252.pop()).dispose();
            }
            var_252 = null;
            while(false)
            {
      ...
      {
         return var_252[param1].getDesktopWindow().getChildAt(var_233.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1416 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1416 = new ProfilerOutput(_loc3_,this,var_797);
               var_1417 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1417);
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_1020.length > 0)
         {
            var_1415.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_370 - 1;
            while(_loc2_ >= 0)
            {
               var_252[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1154)
         ...
         var_1415.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_370)
         {
            var_252[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1154)
         {
         ...
         if(WindowContext.var_1020.length > 0)
         {
            WindowContext.var_1020.flush();
         }
         if(WindowContext.var_1483.length > 0)
         {
            WindowContext.var_1483.flush();
         }
         var_1415.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1224,new Date().getTime().toString());
