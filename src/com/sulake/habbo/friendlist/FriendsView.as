package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2261:IContainerButtonWindow;
      
      private var var_2264:IContainerButtonWindow;
      
      private var var_2263:IContainerButtonWindow;
      
      private var var_2262:IContainerButtonWindow;
      
      private var var_384:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_384 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_2264 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2263 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2261 = initButton("room_invite",onInviteButtonClick,param1);
         var_2262 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_384.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_384.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_27)
         {
            this.var_384.closePopup();
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2264,isEnableMinimailButton(_loc1_));
         setEnabled(var_2263,isEnableHomeButton(_loc1_));
         setEnabled(var_2261,isEnableInviteButton(_loc1_));
         setEnabled(var_2262,isEnableRemoveButton(_loc1_));
      }
