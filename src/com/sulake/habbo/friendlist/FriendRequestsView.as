package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_325 && _loc4_.state != FriendRequest.const_345)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_325;
      ...
      {
         var_1571 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1572 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1572.procedure = onDismissAllButtonClick;
         var_1571.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_325)
         {
         ...
         else if(param1.state == FriendRequest.const_995)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_325;
