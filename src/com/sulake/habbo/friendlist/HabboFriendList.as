package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1712:OpenedToWebPopup;
      
      private var var_943:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_471:FriendListTabs;
      ...
      private var var_1713:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_684:ISessionDataManager;
      
      private var var_394:FriendRequests;
      
      private var var_2327:int;
      
      var var_96:FriendCategories;
      
      private var var_2381:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1001:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2381 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_96 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1713 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_394.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_394.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_471.findTab(FriendListTab.const_87).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_684 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_394 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_96.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_96.addCategory(new FriendCategory(FriendCategory.const_961,getText("friendlist.friends")));
         var_96.addCategory(new FriendCategory(FriendCategory.const_391,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_96.addFriend(new Friend(_loc4_));
         }
         var_471 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_581)
         {
            var_581 = new Timer(120000);
            var_581.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_581.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_581.stop();
            var_581.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_581 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_943)
         {
            var_943.release(new IIDAvatarRenderManager());
            var_943 = null;
         }
         if(var_1001)
         {
            var_1001.release(new IIDHabboNotifications());
            var_1001 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_684)
         {
            var_684.release(new IIDSessionDataManager());
            var_684 = null;
         }
         super.dispose();
      }
      ...
      {
         var _loc1_:String = var_136.getKey("client.minimail.embed.enabled");
         return _loc1_ == "ParkBusCannotEnterMessageParser";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_471.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1713.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_394.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_684.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_684.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_394.limit)
         {
            var_394.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_471.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      private function onRoomInviteError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:String = "Received room invite error: errorCode: " + _loc2_.errorCode + ", recipients: " + Util.arrayToString(_loc2_.method_12);
         new SimpleAlertView(this,"${friendlist.alert.title}",_loc3_).show();
      }
      
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         var _loc2_:IAvatarImage = var_943.createAvatarImage(param1,AvatarScaleType.SMALL,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_394.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_471.findTab(FriendListTab.const_87);
      ...
      {
         var_1001 = param2 as IHabboNotifications;
      ...
      {
         return var_136.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1712 == null)
         {
            var_1712 = new OpenedToWebPopup(this);
         }
         var_1712.show(x,y);
      }
