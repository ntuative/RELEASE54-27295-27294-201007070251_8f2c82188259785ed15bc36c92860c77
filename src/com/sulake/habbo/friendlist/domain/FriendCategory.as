package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_354:int = 100;
      ...
      {
         return Math.ceil(this.var_249.length / const_354);
      }
      ...
      {
         if(this.var_961 >= this.getPageCount())
         {
            this.var_961 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_961 + 1) * const_354,this.var_249.length);
      }
