package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_710 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_710.procedure = onSearchInput;
         var_710.addEventListener(WindowKeyboardEvent.const_147,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_384.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_384.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_51.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_348,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      public function refreshList() : void
      {
         ...
         while(true)
         {
            ...
            {
               refreshEntry(true,_loc2_,null,null,method_5(),false,false,false,0);
            }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_710.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
