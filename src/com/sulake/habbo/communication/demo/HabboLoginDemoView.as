package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_617:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_177.shockwaveClientUrl = var_116.shockwaveClientUrl;
         var_177.ssoTicket = var_116.ticket;
         var_116.removeEventListener(SSOTicket.const_355,onParsedTicketSuccess);
         var_116.removeEventListener(SSOTicket.const_267,onParsedTicketFailure);
         var_116 = null;
         dispatchEvent(new Event(const_617));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1463,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_177.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_102,HabboWindowStyle.const_35,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1463,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_177.habboConfiguration.getKey("use.sso","false") == "ParkBusCannotEnterMessageParser")
            {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_116 = new SSOTicket(var_177.assets,_loc2_,_loc1_);
         var_116.addEventListener(SSOTicket.const_355,onParsedTicketSuccess);
         var_116.addEventListener(SSOTicket.const_267,onParsedTicketFailure);
      }
