package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2378:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1709:ILogger;
      
      private var var_1468:String;
      
      private var var_2377:String;
      
      private const const_1463:String = "fuselogin";
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2376)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_826 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_826);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         var_1185 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_208);
         connection.send(new VersionCheckMessageComposer(401,var_1468,var_2377));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(const_1463,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_473.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_473.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2378);
      ...
      {
         var_826 = _habboConfiguration.getKey("sso.ticket",null);
         var_1468 = _habboConfiguration.getKey("flash.client.url","");
         var_2377 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_193 == null)
         {
         ...
         if(var_826 != null)
         {
            var_64.mode = HabboConnectionType.const_410;
            var_64.initConnection(HabboConnectionType.const_276);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1709 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_769);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2378 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_64.mode)
         {
            case HabboConnectionType.const_410:
               _loc6_ = "";
               ...
               var_1186 = _loc4_;
               var_193.loadBannerImage(_loc7_ + "?token=" + var_1186,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_996:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1340:
               var_682 = generateRandomHexString(30);
               var_473 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_473.init(var_682);
               _loc8_ = var_473.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1186);
         ...
         var_473 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_473.init(_loc14_);
            _loc15_ = var_473.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_996;
            }
         }
         var_64.initConnection(HabboConnectionType.const_276);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_179,onConfigurationLoaded);
         }
      }
