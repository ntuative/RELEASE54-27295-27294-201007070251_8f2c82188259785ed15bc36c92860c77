package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1743:int = 13421772;
      ...
      protected var var_2432:BitmapData;
      
      protected var var_1026:Boolean;
      
      protected var var_2420:Boolean;
      
      protected var var_1883:int;
      ...
      private const const_1742:int = 8947848;
      ...
      private const const_1484:Number = 0.2;
      
      protected var var_1494:Boolean;
      
      private const const_1483:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_652)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1612));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1484;
               _loc1_.blend = const_1484;
            }
            else
            {
               _window.blend = const_1483;
               _loc1_.blend = const_1483;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1494 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2432;
               _loc5_.visible = true;
            }
            else
            {
