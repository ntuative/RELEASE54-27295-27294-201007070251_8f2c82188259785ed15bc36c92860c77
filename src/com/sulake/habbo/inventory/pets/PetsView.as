package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_322:PetsGridItem;
      ...
      {
         if(var_647 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_647.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_322 != null)
         {
            var_322.setSelected(false);
         }
         var_322 = param1;
         if(var_322 != null)
         {
            var_322.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_322.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_647.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_647.getValue(param1.id) != null)
         {
            return;
         }
