package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_873:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_21 != null)
         {
            ...
            var_21.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_436,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_110:
               var_873 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_436:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_49.getValue(InventoryCategory.const_597));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_49.getValue(InventoryCategory.const_77));
      }
      ...
      {
         return PetsModel(var_49.getValue(InventoryCategory.const_143));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1730);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_49.getValue(InventoryCategory.const_304));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_253:
               _view.toggleCategoryView(InventoryCategory.const_77,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_874.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_874.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_49.getValue(InventorySubCategory.const_253));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_372 = ISessionDataManager(param2);
      ...
      {
         return var_49.getValue(InventoryCategory.const_358) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1063 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_49.getValue(InventoryCategory.const_272));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_21.events.addEventListener(RoomSessionPropertyUpdateEvent.const_436,roomSessionEventHandler);
         ...
         var_49.add(InventoryCategory.const_358,_loc3_);
         ...
         var_49.add(InventoryCategory.const_77,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_372);
         var_49.add(InventoryCategory.const_272,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_49.add(InventoryCategory.const_597,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_372);
         var_49.add(InventoryCategory.const_304,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_49.add(InventorySubCategory.const_253,_loc8_);
         ...
         var_49.add(InventoryCategory.const_143,_loc10_);
