package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_77,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_597);
         _loc2_.refreshViews();
         var_14.notifyChangedEffects();
      }
      ...
      {
         var _loc2_:* = null;
         if(var_14.isInventoryCategoryInit(InventoryCategory.const_358))
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_143);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_14.setInventoryCategoryInit(InventoryCategory.const_304);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_14.setInventoryCategoryInit(InventoryCategory.const_77);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_14.toggleInventorySubPage(InventorySubCategory.const_253);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_14.setInventoryCategoryInit(InventoryCategory.const_272);
      }
