package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1127:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_657 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_657.width;
         var_97 = var_657.height;
         var_1128 = param5;
         var_951 = param6;
         var_244 = Math.floor(var_1128 / _thumbWidth);
         var_20 = new BitmapData(var_1128,var_951);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_244 + _loc2_.x);
      }
      ...
      private function method_9() : Point
      {
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_244 - param1.x - 1;
         ...
         if(var_20.height < var_951)
         {
            _loc12_ = new BitmapData(var_20.width,var_951);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_657.width,var_657.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_657.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_657,var_657.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1127 != null)
         {
            _loc1_ = var_1127.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_548 = resolveRowCountFromList();
         if(var_548 == 0)
         {
            var_20 = new BitmapData(var_1128,var_951);
            return;
         }
         var_20 = new BitmapData(Math.max(var_244 * _thumbWidth,var_1128),Math.max(var_548 * var_97,var_951),true,16777215);
         var_20.fillRect(var_20.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_548)
         {
            _loc4_ = 0;
            while(_loc4_ < var_244)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         var _loc3_:Point = method_9();
         if(_loc3_.x == var_244 && var_20.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_244 - 1),var_97);
         _loc2_.copyPixels(var_20,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_244 - 1),0,_thumbWidth,var_20.height);
         _loc2_.copyPixels(var_20,_loc4_,new Point(0,var_97),null,null,true);
         _loc4_ = new Rectangle(0,var_97,_thumbWidth * (var_244 - 1),0 - var_97);
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_244));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_244);
         var _loc3_:int = param1 % var_244;
         return new Point(_loc3_,_loc2_);
      }
