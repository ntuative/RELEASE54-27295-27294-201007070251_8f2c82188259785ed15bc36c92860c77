package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_547 = new Timer(const_1145,1);
         var_547.addEventListener(TimerEvent.TIMER_COMPLETE,method_8);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_253;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_440.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_440.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_652)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_547 != null)
            {
               var_547.removeEventListener(TimerEvent.TIMER_COMPLETE,method_8);
               var_547.stop();
               var_547 = null;
            }
            if(var_143 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_779 == null)
         {
            var_779 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_779.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_253:
               ...
               break;
            case InventorySubCategory.const_994:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_358);
      ...
      {
         if(param1 == InventoryCategory.const_77 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_40:
                  ...
                  break;
               case const_312:
                  _controller.toggleInventoryPage(InventoryCategory.const_143);
            }
         }
      }
      
      private function method_8(param1:TimerEvent) : void
      {
         initListImages();
      }
      ...
      {
         if(var_947 && param1.type == RoomEngineObjectEvent.const_220)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_347 || _loc3_.category == FurniCategory.const_334 || _loc3_.category == FurniCategory.const_333)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_440 = new Map();
         var_440.add(const_39,new Array());
         var_440.add(const_40,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
