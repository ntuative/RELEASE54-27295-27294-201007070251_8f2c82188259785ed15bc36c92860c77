package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_384:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_384 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            var_384.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_403);
            var_384.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_190)
            {
               var_190.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_190.stop();
               var_190 = null;
            }
            if(var_384 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1664 == null)
         {
            var_1664 = createMinimizedWindow();
         }
         if(!var_2250)
         {
            return var_66;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_190 == null)
         {
            var_190 = new Timer(1000,3);
            var_190.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_190.reset();
         var_190.repeatCount = 3;
         var_190.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_819) : uint(const_820);
            }
