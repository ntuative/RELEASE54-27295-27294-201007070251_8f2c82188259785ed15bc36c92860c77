package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         var_103 = param2.createWindow("TOOLBAR_ICON_" + param4 + "_REGION","",WindowType.const_412,HabboWindowStyle.const_35,HabboWindowParam.const_38,new Rectangle(0,0,1,1),onMouseEvent) as IRegionWindow;
      ...
      {
         return var_1523[var_1049.indexOf(param1)];
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(var_269)
               {
                  var_269.repositionWindow(var_714,true);
               }
               if(_events != null)
               {
      ...
      {
         return var_604.indexOf(param1) > -1;
      }
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = var_855[var_604.indexOf(param1)];
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         if(var_269 != null)
         {
            var_269.animateWindowIn(this,param1,param2,var_714,param3,param4,getMenuYieldList(param1));
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_269 != null)
         {
            var_269.hideWindow(param1,param2,var_714,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_269 != null)
         {
            var_269.positionWindow(this,param1,param2,var_714,param3,getMenuYieldList(param1));
         }
      }
      ...
      private function setAnimator() : void
      {
         ...
         var _loc1_:StateItem = getCurrentStateObject();
         if(_loc1_ != null && var_1047)
         {
            if(_loc1_.frames == null)
            {
               return;
            }
            var_406 = new ToolbarIconAnimator(_loc1_,_assetLibrary,_window,var_91,_y,_bitmapData);
            if(false)
            {
      ...
      {
         return var_1796 + var_494.windowMargin;
      }
