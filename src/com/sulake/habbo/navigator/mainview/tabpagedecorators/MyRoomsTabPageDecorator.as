package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_580:IDropMenuWindow;
      
      private var var_2543:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_695;
         }
         if(param1 == 3)
         {
            return Tabs.const_632;
         }
         if(param1 == 4)
         {
      ...
      {
         var _loc1_:int = var_580 == null ? 0 : int(var_580.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_289,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_580 == null)
         {
            var_580 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_580.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
