package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1506:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_212,Tabs.const_210,"-1",MainViewCtrl.const_743);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1506 == null)
         {
            ...
            var_1506 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1506.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
