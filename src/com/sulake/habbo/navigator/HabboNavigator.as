package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2526:Dictionary;
      ...
      private var var_934:RoomCreateViewCtrl;
      
      private var var_2069:RoomThumbnailRenderer;
      ...
      private var var_471:Tabs;
      
      private var var_278:MainViewCtrl;
      
      private var var_2070:Array;
      
      private var var_1096:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_278 = new MainViewCtrl(this);
         var_537 = new RoomInfoViewCtrl(this);
         var_934 = new RoomCreateViewCtrl(this);
         var_2069 = new RoomThumbnailRenderer(this);
         var_1096 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_471 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_278.startSearch(Tabs.const_212,Tabs.const_346,param1);
         var_278.mainWindow.activate();
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_136.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var_537.userDefinedRoomEventsCtrl.stuffSelected(param1,param2);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_278.startSearch(Tabs.const_289,Tabs.const_214);
         var_471.getTab(Tabs.const_289).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_278.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
