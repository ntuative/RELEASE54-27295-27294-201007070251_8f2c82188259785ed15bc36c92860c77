package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         {
            case CantConnectMessageParser.const_1354:
            ...
            case CantConnectMessageParser.const_1205:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1324:
      ...
      private function setToolbarExitIcon() : void
      {
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_173,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_170 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      {
         if(_navigator.configuration.getKey("roomenterad.habblet.enabled") == "ParkBusCannotEnterMessageParser" && false)
         {
