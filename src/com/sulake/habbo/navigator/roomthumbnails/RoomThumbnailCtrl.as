package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1529,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1530,this._model.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1530 = IButtonWindow(find("obj_tab"));
         var_1807 = IWindowContainer(find("tile_grid"));
         var_1808 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1530,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1807;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_433)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1808;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_51,HabboWindowStyle.const_37,HabboWindowParam.const_69,new Rectangle(0,0,param1.width,66)));
