package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_776:int = 32;
      
      private static const const_1082:int = 8;
      
      public static const const_433:int = 10;
      
      private static const const_1083:int = 40;
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_854.getImage(ThumbnailEditorModel.const_32,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1081,_loc4_.y + const_1083 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1791[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_854.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_854.getImage(ThumbnailEditorModel.const_36,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_854.getImage(ThumbnailEditorModel.const_53,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_776 / 2);
         return new Point(param1 * const_776 + _loc3_,param2 * const_1082);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_433)
         {
            var_1043[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1043[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_433)
         {
            if(false)
            {
               refreshObj(param1,var_1043[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1236 == null)
         {
            var_1236 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1236,var_1236.rect,new Point(0,0),null,null,true);
      }
   }
}
