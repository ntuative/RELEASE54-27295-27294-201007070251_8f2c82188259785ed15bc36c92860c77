package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(var_334)
         {
            var_334.removeEventListener(TimerEvent.TIMER,onHideTimer);
            var_334.reset();
            var_334 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_52 == null)
         {
            var_52 = IWindowContainer(_navigator.getXmlWindow(var_1248));
            var_52.visible = false;
         ...
         var_52.x = _loc2_.x + var_1879 + param1.width;
