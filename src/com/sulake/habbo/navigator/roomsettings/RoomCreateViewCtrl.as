package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_988:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_574 = new Timer(100);
         var_574.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_41 = new Array();
         ...
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"g"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,74,"h"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,416,"o"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,352,"p"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,304,"q"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,336,"r"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,748,"u"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,438,"v"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,540,"t"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,512,"w"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,396,"x"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,440,"y"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,456,"z"));
         var_41.push(new RoomLayout(HabboClubLevelEnum.const_50,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1166 = new TextFieldManager(_navigator,ITextFieldWindow(var_22.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_574)
         {
            var_574.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_574.reset();
            var_574 = null;
         }
      }
      ...
      {
         var_1166.include();
         var_1166.input.textBackgroundColor = 4294967295;
         var_988 = var_41[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_51,HabboWindowStyle.const_37,HabboWindowParam.const_69,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1166.getText();
      ...
      {
         var _loc1_:Boolean = var_1166.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_988.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1448 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1448 = true;
            _loc3_.y = 1;
