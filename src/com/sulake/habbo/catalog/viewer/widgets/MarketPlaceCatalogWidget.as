   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private function updateList() : void
      {
         ...
         if(!var_535)
         {
            ...
            var_535 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_535)
         {
            return;
         ...
         updateStatusDisplay(const_1479,_loc2_.length);
         if(!var_429)
         {
            var_429 = new Timer(25);
            var_429.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_932 = 0;
         populateList();
         var_429.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_634)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_535 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_535.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1480);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_430.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_429)
         {
            var_429.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_429 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_932 >= var_634.length)
            {
               return true;
            }
            addListItem(var_634.getWithIndex(var_932));
            ++var_932;
            _loc1_++;
         }
         return false;
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_430));
            _loc7_.selection = 0;
         }
      }
