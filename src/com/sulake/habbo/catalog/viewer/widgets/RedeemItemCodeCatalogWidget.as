package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1071 != null)
         {
            var_1071.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,method_6);
         }
         if(var_1070 != null)
         {
            var_1070.removeEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(var_1071 != null)
         {
            var_1071.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,method_6);
         }
         var_1070 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1070 != null)
         {
            var_1070.addEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
