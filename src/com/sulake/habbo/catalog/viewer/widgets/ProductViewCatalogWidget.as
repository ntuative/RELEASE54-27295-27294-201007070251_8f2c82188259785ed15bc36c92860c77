package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1263:IScrollbarWindow;
      
      protected var var_1363:XML;
      
      private var var_1262:BitmapData;
      
      private var var_1245:ITextWindow;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_471:
                  _loc4_ = var_1262.clone();
                  if(var_615 != null)
                  {
                     var_615.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_615,var_1263,var_1363);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_222:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_281,AvatarAction.const_485);
                              _loc13_.appendAction(AvatarAction.const_420,_loc6_.productClassId);
      ...
      override public function init() : void
      {
         ...
         var_1245 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1545 = new Point(var_85.x,var_85.y);
         var_615 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1263 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_615 == null)
         {
         ...
         var_1262 = _loc2_.content as BitmapData;
