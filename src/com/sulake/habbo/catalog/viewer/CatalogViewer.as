package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1502:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_448 != null)
         {
            if(var_448.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_448.window);
            var_448.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1502);
         var_448 = _loc5_;
      ...
      {
         return var_448.dispatchWidgetEvent(param1);
      }
