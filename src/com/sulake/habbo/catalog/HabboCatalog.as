package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_215:PurchaseConfirmationDialog;
      
      private var var_540:IHabboSoundManager;
      
      private var var_325:CatalogViewer;
      
      private var var_2099:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_437:ICatalogNavigator;
      ...
      private var var_2101:GiftWrappingConfiguration;
      ...
      private var var_1117:ClubGiftController;
      ...
      {
         return var_372.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2100 && var_540 != null)
         {
            var_540.playSound(HabboSoundTypesEnum.const_869);
         }
         var_2100 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_372.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_79)
         {
            _loc3_ = var_372.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_436 == null)
         {
            var_436 = new ClubBuyController(this);
         }
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_215.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "ParkBusCannotEnterMessageParser" == var_136.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_136.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2101 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_939)
         {
            if(!var_372.loadProductData(this))
            {
               return;
            }
            init();
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_232,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1117.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_437 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_1117 == null)
         {
            var_1117 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_215 == null)
            {
               var_215 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_215.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_436.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_437.buildCatalogIndex(_loc2_);
         if(var_1116 != "")
         {
            var_437.openPage(var_1116);
            var_1116 = "";
         }
         else
         {
            var_437.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_157)
         {
            _loc3_ = var_136.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_90.storePrizeTable(_loc2_.method_13);
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2099 && var_540 != null)
         {
            var_540.playSound(HabboSoundTypesEnum.const_1025);
         }
         var_2099 = false;
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_325 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_325.habboCatalog = this;
      }
