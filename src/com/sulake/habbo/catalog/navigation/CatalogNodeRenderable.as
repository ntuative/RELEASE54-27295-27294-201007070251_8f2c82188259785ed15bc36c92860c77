package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1158:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1650:XML;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1650 == null)
         {
            ...
            var_1650 = _loc4_.content as XML;
         }
         if(var_1652 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1651 == 4294967295)
            {
               var_1651 = _loc1_.color;
            }
            _loc1_.color = const_1158;
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1650) as IWindowContainer;
         }
         else
         {
