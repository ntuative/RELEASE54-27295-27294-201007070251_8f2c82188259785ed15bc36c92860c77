package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2509:String = "magic.pixels";
      
      private var var_2510:String = "catalog.page.club";
      
      private var var_2535:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","false") == "ParkBusCannotEnterMessageParser";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2510,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_288.indexOf(param1) > -1;
         ...
         {
            _loc6_.close();
            _loc7_ = var_288.indexOf(_loc6_);
            var_288.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
