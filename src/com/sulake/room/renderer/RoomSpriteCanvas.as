package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_2267:Number = -1.0E7;
      
      private var var_2270:Number = -1.0E7;
      
      private var var_2511:int = 0;
      
      private var var_563:RoomObjectCache;
      
      private var var_795:int;
      
      private var var_291:Sprite;
      
      private var var_1152:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_251 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
         ...
         var_328 = new Map();
         var_563 = new RoomObjectCache(_loc6_);
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_251.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_251.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      {
         var_563.removeObjectCache(param1);
      }
      ...
      public function update() : void
      {
         if(var_970 == 0)
         {
            checkMouseHits(var_1153.x,var_1153.y,MouseEvent.MOUSE_MOVE);
         }
         var_970 = 0;
         ++var_735;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_291 != null)
         {
            var_291.graphics.clear();
         }
         else
         {
            var_291 = new Sprite();
            var_291.name = "mask";
            _master.addChild(var_291);
         }
         var_291.graphics.beginFill(0);
         var_291.graphics.drawRect(0,0,param1,param2);
         var_795 = param1;
         var_796 = param2;
         var_55.graphics.clear();
         var_55.graphics.beginFill(var_2511);
      ...
      {
         var _loc11_:Number = param1 - var_795 / 2;
         var _loc12_:Number = param2 - var_796 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_795 != var_2266 || var_796 != var_2269)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
      ...
      public function dispose() : void
      {
         ...
         if(var_561 != null)
         {
            ...
            {
               cleanSprite(var_561[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_561 = [];
         }
         ...
         while(_loc1_ < var_328.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1152 != null)
                  {
                     var_1152.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_735,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_251.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_251.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1153.x = param1;
         var_1153.y = param2;
         if(var_970 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1668;
         }
         var_1668 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_970;
         return var_1668;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_562.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_562.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2267 || param2 != var_2270)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_562.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_562.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_561.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_251.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_251.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_563.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_563.getObjectCache(param2);
         ...
         _loc13_ += int(var_795 / 2);
         _loc14_ += int(var_796 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_795 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_796))
                  {
