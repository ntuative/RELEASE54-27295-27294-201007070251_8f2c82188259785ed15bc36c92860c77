package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_635:Number = 64;
      ...
      private var var_1630:Number = 1.0;
      
      private var var_91:Vector3d;
      
      private var var_92:Vector3d;
      
      private var var_2507:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_92 = new Vector3d();
         var_1133 = new Vector3d();
         var_1628 = 1;
         var_1630 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1629 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_446 != param1 * var_1629)
         {
            var_446 = param1 * var_1629;
            ++var_81;
         }
      }
      ...
      {
         if(var_444 != param1 * var_1628)
         {
            var_444 = param1 * var_1628;
            ++var_81;
         }
      }
      ...
      {
         if(var_447 != param1 * var_1630)
         {
            var_447 = param1 * var_1630;
            ++var_81;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1133.assign(_loc22_);
         }
         else
         {
            var_1133.assign(_loc17_);
         }
         ++var_81;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_447;
         _loc2_.z *= var_446;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1133);
         if(_loc3_ < var_2507 || _loc3_ > var_2508)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_447;
            _loc2_.z *= var_446;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1133);
         }
      ...
      {
         return new Vector3d(0 * var_444,0 * var_447,0 * var_446);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_444,0 * var_447,0 * var_446);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_92;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_444,param2.y * var_447,param2.z * var_446);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_444,param3.y * var_447,param3.z * var_446);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_444,param4.y * var_447,param4.z * var_446);
