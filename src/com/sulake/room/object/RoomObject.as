package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private var var_455:IRoomObjectEventHandler;
      ...
      public function RoomObject(param1:int, param2:int)
      {
         ...
         var_1656 = new Vector3d();
         var_1655 = new Vector3d();
         var_559 = new Array(param2);
      ...
      {
         var_1655.assign(var_246);
         return var_1655;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_559.length)
         {
            if(var_559[param2] != param1)
            {
               var_559[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      public function setEventHandler(param1:IRoomObjectEventHandler) : void
      {
         ...
         var _loc2_:IRoomObjectEventHandler = var_455;
         if(_loc2_ != null)
         {
            var_455 = null;
            _loc2_.object = null;
      ...
      {
         if(param1 >= 0 && param1 < var_559.length)
         {
